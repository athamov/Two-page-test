function Header() {
  return (
    <div className="flex row justify-between h-[70px]">
      <a href="#" className="ml-16 mt-[26px] text-xs leading-[19px] font-normal">LOGO</a>
      <div className="flex row justify-end">
        <div className="hover:cursor-pointer">
          <span className="absolute pl-[6px] w-4 h-4 text-white text-[10px] top-4 right-[282px] rounded-full bg-Success">1</span>
          <span className="mx-[23px] mr-[40px]">
