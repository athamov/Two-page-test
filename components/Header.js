    ...
    <div className="flex row justify-between h-[70px]">
      ...
      <div className="flex row justify-end">
        <div className="relative mt-1 mr-5 px-3 w-10 group hover:cursor-pointer hover:w-[280px] hover:bg-Success hover:rounded-full duration-150 ease-linear">
          <div>
            <span className="absolute pl-[6px] w-4 h-4 text-white text-[10px] top-5 right-0.5 rounded-full bg-Success group-hover:right-60 group-hover:bg-white group-hover:text-Success">1</span>
          ...
          <div className="absolute invisible top-6 -left-36 group-hover:left-12 w-[250px] flex flex-row group-hover:visible duration-150">
